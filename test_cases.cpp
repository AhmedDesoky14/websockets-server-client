...
//     std::shared_ptr<client_abstract> client1 = std::make_shared<wss_client>(server_key_file_path);
...
//     wss_server* new_server_less_secure = wss_server::Create(8083,4,server_key_file_path);
